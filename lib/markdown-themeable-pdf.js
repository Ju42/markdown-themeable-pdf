...
var scriptParameters = process.argv.slice(2);

if(scriptParameters.length < 1) throw new Error("No arguments");

var markdownFile = scriptParameters[0];
...
var atom = {
    config:{
        ...
        get:function(key){
            switch(key)
            {
                case 'markdown-themeable-pdf.exportFileType':
                    return 'pdf';
                    break;
                case 'markdown-themeable-pdf.codeHighlightingTheme':
                    return 'github-gist.css';
                    break;
                case 'markdown-themeable-pdf.enableHtmlInMarkdown':
                    return true;
                    break;
                case 'markdown-themeable-pdf.enableLinkify':
                    return true;
                    break;
                case 'markdown-themeable-pdf.enableXHTML':
                    return true;
                    break;
                case 'markdown-themeable-pdf.enableBreaks':
                    return true;
                    break;
                case 'markdown-themeable-pdf.smartQuotes':
                    return true;
                    break;
                case 'markdown-themeable-pdf.enableCheckboxes':
                    return true;
                    break;
                case 'markdown-themeable-pdf.enableSmartArrows':
                    return true;
                    break;
                case 'core.fileEncoding':
                    return 'utf8';
                    break;
                case 'markdown-themeable-pdf.customStylesPath':
                    return '../markdown-themeable-pdf/styles.css';
                    break;
                case 'markdown-themeable-pdf.width':
                    return '10.5in';
                    break;
                case 'markdown-themeable-pdf.height':
                    return '8in';
                    break;
                case 'markdown-themeable-pdf.format':
                    return 'A4';
                    break;
                case 'markdown-themeable-pdf.orientation':
                    return 'portrait';
                    break;
                case 'markdown-themeable-pdf.pageBorder':
                    return '1cm';
                    break;
                case 'markdown-themeable-pdf.imageQuality':
                    return 90;
                    break;
                case 'markdown-themeable-pdf.openPdfInAtomWorkspace':
                    return false;
                    break;
                case 'markdown-themeable-pdf.preWrap':
                    return true;
                    break;
                case 'markdown-themeable-pdf.enableCustomHeader':
                    return true;
                    break;
                case 'markdown-themeable-pdf.customHeaderPath':
                    return '../markdown-themeable-pdf/header.js';
                    break;
                case 'markdown-themeable-pdf.enableCustomFooter':
                    return true;
                    break;
                case 'markdown-themeable-pdf.customFooterPath':
                    return '../markdown-themeable-pdf/footer.js';
                    break;
            }
        }
    },
    project:{
        getPaths:function () {
            return "/home/ju/WIP/markdown-themeable-pdf";
        }
    }
};

var markdownThemeablePdf = {
    config: {
        exportFileType: {
            type: 'string',
            default: 'pdf',
...
markdownThemeablePdf.convertFile(markdownFile,'utf8');